...
///@brief The bleGenericService class is the top level class for a bluetooth service in SensorTag2.
/// It contains the basic functionality for enabling and disabling SensorTag services.\n\n
/// All the SensorTag2 services abide to the following logic when it comes to characteristics:
