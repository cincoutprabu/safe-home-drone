...
-(instancetype) initWithService:(CBService *)service {
    ...
    if (self) {
        ...
        self.tile.title.text = @"Command Button";
    }
    return self;
}
...
-(NSString *) calcValue:(NSData *) value {
    ...
    if (self.key1)
    {
        ...
        //UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"SafeHome" message:@"Panic" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
        //[alert show];
    }
